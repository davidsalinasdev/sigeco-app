                                            ...
                                            ->where('nombre', '<>', 'Contratación Menor Bienes (1-20.000)')
                                                ->where('nombre', '<>', 'Contratación Menor Servicio (1-20.000)')
                                                    ->where('nombre', '<>', 'Contratación Menor Consultoría (1-20.000)')
                                                        ->where('nombre', '<>', 'Contratación Menor Directa de Servicios (1-20.000)')
                                                            ->where('nombre', '<>', 'Contratación Menor de Consultores Individuales de Linea (1-20.000)')
                                                                ->where('nombre', '<>', 'Contratación Menor de Consultorias por Producto (1-20.000)')
                                                                    ->orderBy('id', 'asc')
                                                                    ->get();
                                                                    @endphp
