                        ...
                        @foreach($procesosconts as $procesoscont)
                            <tr>
                                ...
                                @else
                                    <td>
                                        {{--BOTON Ver/Imprimir--}}
                                        <a class="btn btn-primary" href="{{route('procesoscont.pdf_proc', $procesoscont->id)}}" target="_blank">
                                            <i class="fas fa-file-pdf"></i>
                                        </a>
                                        
                                        {{--Seguimiento--}}
                                        <a href="{{ route('trayectoria.seguirproc', ['idproc' => $procesoscont->id, 'deproc' => '1']) }}" alt="Seguimiento">
                                            <button class="btn btn-primary">
...
<script>
    var table = new DataTable('#proces', {
        language: {
