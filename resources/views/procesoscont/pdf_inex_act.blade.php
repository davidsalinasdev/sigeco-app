<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
            ...
            <p>Mediante la presente, solicito que por la unidad que corresponda se emita el informe de enexistecia para <span style="text-transform: lowercase;">{{$proceso->objeto}}</span></p>
            <br>
            <table id="detalle">
                <thead>
                    <tr>
